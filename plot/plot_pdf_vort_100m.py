...
# ../postprocessing/calc_vort_pdf_100m.py PDFs (h <= 100 m only)
print('plotting')

SCEN_KEYS = ['tideswec', 'tidesnowec', 'notidesnowec', 'notideswec', 'ampwec', 'tidesampwec']

# array key inside each npz -- matches ARRAY_KEY in postprocessing/calc_vort_pdf_100m.py
ARRAY_KEY = {
    'tideswec':     'pdf_wec',
...
# total domain, restricted to h <= 100 m
figw = 12
figh = 8
axisfont = 16
...
for scen in SCEN_KEYS:
    npz_path = f'../postprocessing/pdf_vorticity_{scen}_100m.npz'
...
plt.savefig('./figs/pdf_vort_100m.png', bbox_inches='tight')
print('Saved ./figs/pdf_vort_100m.png')

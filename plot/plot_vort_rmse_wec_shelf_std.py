...
the calculation. Vorticity counterpart of plot_w_rmse_wec_shelf_std.py --
same plot, same three comparisons, just the field differs (zeta/f instead of
w). Answers: does WEC change the strength of tidal-bore-driven vorticity,
...
See plot_vort_rmse_wec_shelf.py for the RMSE-only version of this plot
(unmodified).
...
Reads: ../postprocessing/vort_rmse_wec_shelf.npz, ../postprocessing/vort_std.npz
  (std overlay is skipped with a warning if vort_std.npz doesn't exist yet)
Output: ./figs/vort_rmse_wec_shelf_std.png
"""
...
fname = f'{SAVEPATH}vort_rmse_wec_shelf_std.png'

...
Output: ./figs/snapshots/cs_diag_totc_allscen-<ts|tn>-YYYY-MM-DD-HH.png
"""
...
for hf in range(n_files):
    ...
    for t_i in range(his_time.shape[0]):
        ...
        fnames = [f'{SAVEPATH}cs_diag_totc_allscen-{TRANSECT_NAMES[ti]}-{dstr}.png'
        ...
        for ti, tr in enumerate(TRANSECTS):
            ...
            fname = f'{SAVEPATH}cs_diag_totc_allscen-{TRANSECT_NAMES[ti]}-{dstr}.png'

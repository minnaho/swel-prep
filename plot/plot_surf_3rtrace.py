...
for hf in range(len(hisfiles1)):
    ...
    for t_i in range(his_time.shape[0]):
        ...
        #contours0 = ax.flat[0].contour(lon_nc,lat_nc,h_nc,[50,100,500,1000,1500,2000],colors='black',linewidths=.5)
        #contours1 = ax.flat[1].contour(lon_nc,lat_nc,h_nc,[50,100,500,1000,1500,2000],colors='black',linewidths=.5)
        #contours2 = ax.flat[2].contour(lon_nc,lat_nc,h_nc,[50,100,500,1000,1500,2000],colors='black',linewidths=.5)
        ...
        #clabels0 = ax.flat[0].clabel(contours0,inline=False,fontsize=8,fmt='%d',manual=manual_pos)
        #clabels1 = ax.flat[1].clabel(contours1,inline=False,fontsize=8,fmt='%d',manual=manual_pos)
        #clabels2 = ax.flat[2].clabel(contours2,inline=False,fontsize=8,fmt='%d',manual=manual_pos)

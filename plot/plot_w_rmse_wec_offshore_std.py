...
h > 100 m), each line a comparison against the notidesnowec base case -- see
postprocessing/calc_w_rmse_wec_offshore.py for the calculation. Answers:
...
now generally extends below zero. See plot_w_rmse_wec_offshore.py for the
...
Reads: ../postprocessing/w_rmse_wec_offshore.npz, ../postprocessing/w_std.npz
  (std overlay is skipped with a warning if w_std.npz doesn't exist yet)
Output: ./figs/w_rmse_wec_offshore_std.png
"""
...
fname = f'{SAVEPATH}w_rmse_wec_offshore_std.png'

...
CACHE   = f'./figs/offshore_flux_profile_zslice_fix_cache_{TRACER}.npz'
...
if os.path.exists(CACHE):
    ...
    for name in scenarios:
        ...
        F_mean  = np.nanmean(flux_pa, axis=(0, 2))   # (n_z,)
...
out = f'./figs/offshore_flux_profile_zslice_fix_{TRACER}.png'

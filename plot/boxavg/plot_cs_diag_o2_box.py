...
s_rho ROMS output. Box-average variant of ../plot_cs_diag_o2.py.
...
O2 version.
Output: ./figs/snapshots/cs_diag_o2_box_allscen-<ts|tn>-YYYY-MM-DD-HH.png
"""
...
for hf in range(n_files):
    ...
    for t_i in range(his_time.shape[0]):
        ...
        for ti, tr in enumerate(TRANSECTS):
            fname = f'{SAVEPATH}cs_diag_o2_box_allscen-{TRANSECT_NAMES[ti]}-{dstr}.png'

...
for the calculation. Offshore counterpart of plot_vort_rmse_wec_shelf.py --
same plot, opposite side of the h=100 m split. Unlike the shelf version
(capped at ~-100 m), this mask reaches every zslice depth level down to the
seafloor's deepest point, so expect a much taller profile. Also the
vorticity counterpart of plot_w_rmse_wec_offshore.py -- same plot, just the
field differs (zeta/f instead of w).
...
Reads: ../postprocessing/vort_rmse_wec_offshore.npz
Output: ./figs/vort_rmse_wec_offshore.png
"""
...
fname = f'{SAVEPATH}vort_rmse_wec_offshore.png'

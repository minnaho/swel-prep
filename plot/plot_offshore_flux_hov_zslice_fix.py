...
GRD     = 'mc60_grd.nc'
CACHE   = f'./figs/offshore_flux_hov_zslice_fix_cache_{TRACER}.npz'
...
if os.path.exists(CACHE):
    ...
    for name, _ in scenario_rows:
        ...
        F_mean  = np.nanmean(flux_pa, axis=0)     # (n_z, n_valid)
...
out = f'./figs/offshore_flux_hov_zslice_fix_{TRACER}.png'

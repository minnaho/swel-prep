...
mask_rho land mask). Offshore counterpart of calc_wno3_flux_20m_100m.py,
which is the h<=100m (shelf) restriction.

Output: wno3_flux_20m_offshore_<scenario>.npz, wno3_env_20m_offshore_<scenario>.npz
"""
...
for name, (zslice_dir, orig_his_dir) in scenarios.items():
    ...
    outfile    = f'wno3_flux_20m_offshore_{name}.npz'
    outfileenv = f'wno3_env_20m_offshore_{name}.npz'

...
tidesnowec, and notidesnowec covering 2019-04-20 through 2019-04-22.
...
# tidesnowec/notidesnowec reran only this date window — their rerun output
# lands in a rerun_bgcdia/ subdir under dia/, not dia/ itself
SRC_SUBDIR = {
...
for scenario in SCENARIOS:
    ...
    out_dir   = os.path.join(DEST_ROOT, scenario, 'bgcdia')

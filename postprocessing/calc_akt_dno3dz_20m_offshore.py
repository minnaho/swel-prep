...
calc_wno3_flux_20m_offshore.py's resolved eddy flux w'NO3'. Same 4-scenario
...
-- kept here to match calc_akt_dno3dz_20m_100m.py's own convention, even
...
calc_wno3_flux_20m_offshore.py already uses. Both share the exact same fixed
...
Output: akt_dno3dz_flux_20m_offshore_<scenario>.npz, akt_dno3dz_env_20m_offshore_<scenario>.npz
"""
...
# same 4 scenarios as calc_wno3_flux_20m_offshore.py
scenarios = {
...
for name, (zslice_dir, orig_his_dir) in scenarios.items():
    ...
    outfile    = f'akt_dno3dz_flux_20m_offshore_{name}.npz'
    outfileenv = f'akt_dno3dz_env_20m_offshore_{name}.npz'

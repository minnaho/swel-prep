...
calc_wno3_flux_30m_100m.py's resolved eddy flux w'NO3'. Same 4-scenario set,
...
calc_wno3_flux_30m_100m.py already uses. Both share the exact same fixed
...
Output: akt_dno3dz_flux_30m_100m_<scenario>.npz, akt_dno3dz_env_30m_100m_<scenario>.npz
"""
...
# same 4 scenarios as calc_wno3_flux_30m_100m.py
scenarios = {
...
for name, (zslice_dir, orig_his_dir) in scenarios.items():
    ...
    outfile    = f'akt_dno3dz_flux_30m_100m_{name}.npz'
    outfileenv = f'akt_dno3dz_env_30m_100m_{name}.npz'

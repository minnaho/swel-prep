...
tideswec_files = sorted(glob.glob('/data/project3/minnaho/swel/tides/mc60/wec/his/pv/mc60_his.2019042[1-8]*_pv.nc'))
tidesnowec_files = sorted(glob.glob('/data/project3/minnaho/swel/tides/mc60/nowec/output/his/pv/mc60_his.2019042[1-8]*_pv.nc'))
notidesnowec_files = sorted(glob.glob('/data/project3/minnaho/swel/notides/mc60/nowec/output/his/pv/mc60_his.2019042[1-8]*_pv.nc'))
